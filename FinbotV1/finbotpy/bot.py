# -*- coding: utf-8 -*-
r"""
PYTHONPATH=./FinbotV1/finbotpy/bot.py
"""
...
class Bots(object):
    ...
    def sendMessageWithMention(self, to, text='', dataMid=[]):
        ...
        return self.talk.sendMessage(to, text, contentMetadata)

    @loggedIn
    def getTag(self, to, text="", mids=[]):
        arrData = ""
        arr = []
        mention = "@zeroxyuuki "
        if mids == []:
        ...
        self.talk.sendMessage(to, textx, {'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
