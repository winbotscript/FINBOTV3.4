...
r"""
PYTHONPATH=./FinbotServer/fastbinary.py
"""
...
from FinbotServer.protocol.TBinaryProtocol import TBinaryProtocol, TBinaryProtocolAccelerated
from FinbotServer.protocol.TCompactProtocol import TCompactProtocol, TCompactProtocolAccelerated
...
from FinbotServer.protocol.{0} import {0}{1}
